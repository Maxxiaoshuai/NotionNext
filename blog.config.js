...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，欢迎来到普通人的博客, 我会尽我所能分享最优质的内容，欢迎阅读, Stay hungry. Stay foolish. ',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '噗嗤', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '好奇心，谦逊，勇气', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-blog-gamma.vercel.app', // 网站地址
